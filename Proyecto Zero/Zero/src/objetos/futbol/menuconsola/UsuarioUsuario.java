...
public class UsuarioUsuario extends Usuario  {
	...
	public UsuarioUsuario(String usuario_nombre, String usuario_contrasena) {
	...
	public String opcion(String opc_numero, boolean arquero_o_delantero) throws IOException{
