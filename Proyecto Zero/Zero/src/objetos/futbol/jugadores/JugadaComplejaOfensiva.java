...
public class JugadaComplejaOfensiva extends JugadaCompleja implements Serializable{
	int i;
	public JugadaComplejaOfensiva(String NomJug, String FechCrea, String Aut, ArrayList<jugadaPrimitiva> List, String Expli){
		super(NomJug,FechCrea,Aut, List,Expli);
	}
	public void ejecutar(){
		for (i=0;i<this.listaJugadasP.size();i++){
			this.listaJugadasP.get(i).ejecutar();
			System.out.println(this.listaJugadasP.get(i).getInformacion());
			Delay.msDelay(750);
			parar();
		}
	}
