			 ...
			 try{
				 ...
				 if(x==1){
					 ...
					 if(estilo.compareTo("Ofensiva")==0){
						 Delantero.listaTotalJugadas.add(new JugadaComplejaOfensiva(nombre,fe,autor,listaJ,expli));
					 }
					 else if(estilo.compareTo("Defensiva")==0){
						 Delantero.listaTotalJugadas.add(new JugadaComplejaDefensiva(nombre,fe,autor,listaJ,expli));
					 }
					 else if(estilo.compareTo("TiroLibre")==0){
						 Delantero.listaTotalJugadas.add(new JugadaComplejaTiroLibre(nombre,fe,autor,listaJ,expli));
					 }
					 break;
				 }
				 else if(x==2){
