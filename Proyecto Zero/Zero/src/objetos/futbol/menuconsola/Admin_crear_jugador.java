...
public class Admin_crear_jugador extends OpcionDeMenu implements Serializable{
	...
	public void ejecutar(){
		...
		System.out.println("crear el jugador con nombre "+nombre+" con dorso "+dorsal+" y jugadas complejas");
		System.out.println("(1)si"+"\n"+"(2)no");
		String cambiar=scanner.next();
		if (cambiar.compareTo("1")==0){
			if(posicion.compareTo("Delantero")==0){

				MenuDeConsola.lista_delanteros.add(new Delantero(0));
			}
			else if(posicion.compareTo("Arquero")==0){
				MenuDeConsola.lista_arqueros.add(new Arquero(0));
			}
		}
		else{}
	...
	private void elegir_jugadas_complejas(ArrayList<JugadaCompleja> Jc){
